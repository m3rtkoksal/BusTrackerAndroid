...
@Composable
fun PassengerTabBar(
    selectedTab: PassengerHomeTab,
    onTabSelected: (PassengerHomeTab) -> Unit,
    ...
    Column(
        ...
        Row(
            ...
            PassengerHomeTab.entries.forEach { tab ->
                val isSelected = selectedTab == tab
                val accent = if (tab == PassengerHomeTab.Map) NeonTheme.Primary else NeonTheme.Secondary
